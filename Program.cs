...
builder.Services.AddScoped<IAdminDataService<Report>>(sp => sp.GetRequiredService<IReportService>());
...
builder.Services.AddScoped<IAdminDataService<Alert>>(sp => sp.GetRequiredService<IAlertService>());
builder.Services.AddScoped<IDonationService, DonationService>();
builder.Services.AddScoped<IAdminDataService<Donation>>(sp => sp.GetRequiredService<IDonationService>());
builder.Services.AddScoped<IFeedbackService, FeedbackService>();
builder.Services.AddScoped<IAdminDataService<Feedback>>(sp => sp.GetRequiredService<IFeedbackService>());
